...
[X] Input: 12345 -> Kiểm tra với chuỗi số, Entropy xấp xỉ 2.3219.
[X] Input: a = 5, m = 10 -> Kiểm tra cặp số không nguyên tố cùng nhau, kết quả: Không tồn tại nghịch đảo modulo.